        ...
        <div class="container indexdiv">
            ...
            <div class="container p-4">
                <h2 class="text-center"
                    style="font-family:Cambria, Cochin, Georgia, Times, Times New Roman, serif;font-weight:700;">Lorem
                    ipsum dolor</h2>
...
<!-- CREATE TABLE `bbs`.`customers` ( `sno` INT(11) NOT NULL AUTO_INCREMENT , `name` VARCHAR(33) NOT NULL , `accno` VARCHAR(10) NOT NULL , `email` VARCHAR(30) NOT NULL , `phno` VARCHAR(10) NOT NULL , `balance` INT(10) NOT NULL , `address` VARCHAR(355) NOT NULL DEFAULT '4-88-22/12/9 Angara hills, Cyberabad, State - PINCODE ' , PRIMARY KEY (`sno`)) ENGINE = InnoDB; -->
